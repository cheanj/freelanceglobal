...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'aegean');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Aegean'); 
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://cssigniter.com/support/viewtopic.php?f=35&t=191');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=35');
