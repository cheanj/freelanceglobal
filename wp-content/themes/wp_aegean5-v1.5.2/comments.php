...
<?php if (have_comments()): ?>
	<div class="ten offset-by-one post-comments">
		<h2 id="comments" class="double"><span><?php comments_number(__('No comments', 'ci_theme'), __('1 comment', 'ci_theme'), __('% comments', 'ci_theme')); ?></span></h2>
