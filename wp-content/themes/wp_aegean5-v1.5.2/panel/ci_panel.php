...
function ci_panel_upload_image($fieldname, $label)
{
	...
	<?php if( !empty($ci[$fieldname]) ): ?>
		<div class="up-preview-bg group">
			<span class="swatch white" title="<?php echo sprintf(_x('Preview in %s background', 'preview in color background', 'ci_theme'), _x('White', 'color', 'ci_theme')); ?>"></span>
			<span class="swatch grey" title="<?php echo sprintf(_x('Preview in %s background', 'preview in color background', 'ci_theme'), _x('Grey', 'color', 'ci_theme')); ?>"></span>
			<span class="swatch black" title="<?php echo sprintf(_x('Preview in %s background', 'preview in color background', 'ci_theme'), _x('Black', 'color', 'ci_theme')); ?>"></span>
			<span class="swatch transparent" title="<?php echo sprintf(_x('Preview in %s background', 'preview in color background', 'ci_theme'), _x('Transparent', 'color', 'ci_theme')); ?>"></span></div>
	<?php endif; ?>
	<?php
}
